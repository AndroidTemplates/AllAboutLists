 ...
 * Use the {@link SectionedHomogeneousFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SectionedHomogeneousFragment extends Fragment {
   ...
   private  RecyclerView sectionHomogeneous_recycler_vew;
    ...
    SectionedHomogenousAdapter sectionedHomogenousAdapter = null;

    public SectionedHomogeneousFragment() {
    ...
    public static SectionedHomogeneousFragment newInstance(String param1, String param2) {
        SectionedHomogeneousFragment fragment = new SectionedHomogeneousFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sectionHomogeneous_recycler_vew.setAdapter(sectionedHomogenousAdapter);
