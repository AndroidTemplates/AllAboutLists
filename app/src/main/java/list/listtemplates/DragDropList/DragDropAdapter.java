 ...
 */
public class DragDropAdapter extends RecyclerView.Adapter <DragDropAdapter.SimpleType1ViewHolder> {


    private  LayoutInflater inflator;
    List<SimpleDTOType1> simpleDTOTypeList = Collections.EMPTY_LIST;

    public DragDropAdapter(Context context, List<SimpleDTOType1>  data){
    ...
    public void swap(int firstPosition, int secondPosition){
        Collections.swap(simpleDTOTypeList, firstPosition, secondPosition);
