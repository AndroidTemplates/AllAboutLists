package list.listtemplates.MoreApps;
...
import list.listtemplates.SourceCode.SourceCodeAdapter;
...
public class MoreAppsFragment extends Fragment {
    ...
    private HashMap<Integer,String> getURLHash(){
        ...
        urlHash.put(0,"https://play.google.com/store/apps/details?id=com.andr.tutorialapp");
        urlHash.put(1,"https://play.google.com/store/apps/details?id=layout.layoutgenerator");
        return  urlHash;
    }
