...
import list.listtemplates.WebServiceLists.VolleySingleton;
import list.listtemplates.WebServiceLists.WebServiceAdapter;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link DBWebServiceFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DBWebServiceFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    public static final String  URL_VOLLEY = "http://api.walmartlabs.com/v1/paginated/items?format=json&category=3944&apiKey=bb6mt6jayr9cgmwewku8gxp6";
    ...
    public static DBWebServiceFragment newInstance(String param1, String param2) {
        DBWebServiceFragment fragment = new DBWebServiceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(checkNetworkConnectivity()) {
           List<VolleyDTO> volleyDTOList = MyApplication.getWritableDatabase().readProducts("products");
            if(volleyDTOList.size()>0) {
                webServiceAdapter.setVolleyData(volleyDTOList);
            }else {
                getJSON();
            }
        }else{
        ...
        JsonObjectRequest volleyJSONObjectRequest  = new JsonObjectRequest(Request.Method.GET,URL_VOLLEY,(String)null,new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                if(response!=null){
                    ...
                    List<VolleyDTO> volleyDTOList = prepareVolleyList(response);
                    if(volleyDTOList!=null && volleyDTOList.size()>0){
                        populateDataBase(volleyDTOList);
                    }
                    volleyDTOList = MyApplication.getWritableDatabase().readProducts("products");
                    webServiceAdapter.setVolleyData(volleyDTOList);
    ...
    private void populateDataBase(List<VolleyDTO> volleyDTOList){
        MyApplication.getWritableDatabase().insertMovies("products", volleyDTOList, true);
    }
