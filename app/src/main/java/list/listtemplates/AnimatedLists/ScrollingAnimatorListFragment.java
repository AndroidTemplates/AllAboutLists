 ...
 * Use the {@link ScrollingAnimatorListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScrollingAnimatorListFragment extends Fragment implements View.OnClickListener {  // TODO: Rename parameter arguments, choose names that match
    ...
    private ScrollingAnimationListAdapter simpleListType1Adapter;
    FloatingActionButton add_item;
    public ScrollingAnimatorListFragment() {
    ...
    public static ScrollingAnimatorListFragment newInstance(String param1, String param2) {
        ScrollingAnimatorListFragment fragment = new ScrollingAnimatorListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        simpleListType1Adapter = new ScrollingAnimationListAdapter(getActivity(),getData());
