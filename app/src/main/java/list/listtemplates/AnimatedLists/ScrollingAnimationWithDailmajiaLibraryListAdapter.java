 ...
 */
public class ScrollingAnimationWithDailmajiaLibraryListAdapter extends RecyclerView.Adapter <ScrollingAnimationWithDailmajiaLibraryListAdapter.SimpleType1ViewHolder>{
    ...
    public ScrollingAnimationWithDailmajiaLibraryListAdapter(Context context, List<SimpleDTOType1>  data){
    ...
    public void onBindViewHolder(SimpleType1ViewHolder  holder, int position) {
        ...
        if(position>previousPosition){
            AnimationUtils.animateWithdaimajiaLibrary(holder,true);  //scrolls down
        }else{
            AnimationUtils.animateWithdaimajiaLibrary(holder,false);  //scrolls up
        }
