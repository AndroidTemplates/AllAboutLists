 ...
 * Use the {@link ScrollingAnimatorThirdPartyLibListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScrollingAnimatorThirdPartyLibListFragment extends Fragment implements View.OnClickListener {  // TODO: Rename parameter arguments, choose names that match
    ...
    private ScrollingAnimationWithDailmajiaLibraryListAdapter simpleListType1Adapter;
    FloatingActionButton add_item;
    public ScrollingAnimatorThirdPartyLibListFragment() {
    ...
    public static ScrollingAnimatorThirdPartyLibListFragment newInstance(String param1, String param2) {
        ScrollingAnimatorThirdPartyLibListFragment fragment = new ScrollingAnimatorThirdPartyLibListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        simpleListType1Adapter = new ScrollingAnimationWithDailmajiaLibraryListAdapter(getActivity(),getData());
