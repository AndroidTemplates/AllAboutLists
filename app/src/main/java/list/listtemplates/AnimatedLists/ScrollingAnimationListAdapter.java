 ...
 */
public class ScrollingAnimationListAdapter extends RecyclerView.Adapter <ScrollingAnimationListAdapter.SimpleType1ViewHolder>{
    ...
    public ScrollingAnimationListAdapter(Context context, List<SimpleDTOType1>  data){
    ...
    public void onBindViewHolder(SimpleType1ViewHolder  holder, int position) {
        ...
        if(position>previousPosition){
            AnimationUtils.animate(holder,true);  //scrolls down
        }else{
            AnimationUtils.animate(holder,false);  //scrolls up
        }
